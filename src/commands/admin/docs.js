        ...
        switch (interaction.options.getString("message")) {
            ...
            case "welcome":
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setTitle("👋 Bienvenue dans la Communauté d'Experts XperPool !")
                    .setColor(color_basic)
...
Connectez-vous avec des professionnels de divers secteurs, partagez vos expériences et posez des questions sur n'importe quel sujet. Explorez nos missions adaptées à votre profil, __**que vous soyez salarié ou freelance**__, pour booster votre carrière et développer vos compétences ! 
