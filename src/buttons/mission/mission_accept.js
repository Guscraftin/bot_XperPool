...
/**
 * Come from src/buttons/mission/mission_interested.js
 */
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!mission.is_open) return interaction.reply({ content: "La période de candidature pour la mission est désormais close. Toutefois, si de nouvelles candidatures sont ouvertes ultérieurement, tu seras informé dans ce fil de discussion.", ephemeral: true });
